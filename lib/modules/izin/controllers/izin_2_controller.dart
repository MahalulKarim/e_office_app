...
class Izin2Controller extends GetxController {
  ...
  final _imgSuratIzin = XFile('').obs;
  XFile get imgSuratIzin => _imgSuratIzin.value;
  set imgSuratIzin(XFile value) => _imgSuratIzin.value = value;
  ...
  Future<bool> submitIzin(dynamic params) async {
    ...
    final response = await absensiService.tidakMasuk(
      idUser!,
      idPegawai!,
      userController.dataInfoUser.status ?? 0,
      imgSuratIzin,
      formattedDate,
      params['alasan'],
      params['keterangan'],
